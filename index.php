        ...
        <div class="container">
            <div class="card border-dark">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <table class="table table-striped table-sm">
                                <thead >
                                    <tr>
                                        <th class="center-align" scope="col" colspan="6">Resultado Sorteado</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="<?php if ($jogos->marcarNumero($valor, $key, $soterio)) echo " bg-success "; ?>">
                                            <?php echo $valor; ?>
                                        </td>
                                        <?php } ?>
                                    </tr>
                ...
                <div class="row mb-3 ml-3">
                    <div class="col-3">
                        <button type="button" class="btn btn-primary" onClick="window.location.reload()">Gerar Novo</button>
                    </div>
                </div>
            </div>
        </div>
